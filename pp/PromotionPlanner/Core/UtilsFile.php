...
namespace pp\PromotionPlanner\Core;
...
class UtilsFile extends UtilsFile_parent
{
    ...
    protected $_aTypeToPath = ['TC'    => 'master/category/thumb',
        ...
        'FL'    => 'media',
        //
        'PROMO_ARTICLE' => 'master/product/promotionImages',
        'PROMO_MANUFACTURER' => 'master/manufacturer/promotionImages',
        'PROMO_CATEGORY' => 'master/category/promotionImages',
    ];
}